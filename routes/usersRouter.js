...
import { emailSchema } from "../schemas/usersSchema.js";
...
authRouter.get("/verify/:verificationToken", autCtrl.verifyEmail);

authRouter.post("/verify", validateBody(emailSchema), autCtrl.resendEmail);
